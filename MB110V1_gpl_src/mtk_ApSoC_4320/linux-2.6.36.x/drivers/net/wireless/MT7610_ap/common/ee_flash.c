...
/* NOTE: EEPROM_SIZE  doesn't cover all calibration data if you use pre-cal.
	So this function won't save those pre-cal data.
	See ATECALFLASH cmd.
*/
	RtmpFlashWrite(pAd->chipCap.eebuf, RF_OFFSET, EEPROM_SIZE);
...
/*	UCHAR *eepromBuf;*/
	...
	/* note: 0x400 will cover all calibration data including some pre-cal data. */
