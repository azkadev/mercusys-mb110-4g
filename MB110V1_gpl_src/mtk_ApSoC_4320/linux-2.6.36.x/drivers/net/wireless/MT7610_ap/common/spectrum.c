 ...
 */
DOT11_REGULATORY_INFORMATION GLOBALRegulatoryInfo[] =
{
...
#define GLOBAL_REGULATORY_INFO_SIZE (sizeof(GLOBALRegulatoryInfo) / sizeof(DOT11_REGULATORY_INFORMATION))
    ...
    IN UINT8 *ChReptList)
{
    ...
    if ( !pChannelSet )
    {
        DBGPRINT(RT_DEBUG_ERROR,  ("%s: GLOBAL Unknow Requlatory class (%d)\n",
