	...
	IN ChannelSel_Alg Alg)
{
	...
	*/
#ifdef TP_NETWORK_ROAMING
    /*added by ZQQ, 2017.9.8, send the channel*/
    static UCHAR oldCh = 0;
#endif
	...
	else
	{
		...
		if (ch != oldCh)
		{
			/*here send evnet to network-roaming*/
			oldCh = ch;
			send_event_to_network_roaming(pAd->net_dev, IWEVCUSTOM, IEEE80211_EV_CHAN_CHANGE, &ch);
		}
#endif
	}
