...
/*	[Idx]	[Mode]		[MCS]	[PER_Low/High]	[dMCS]	[upMCS3/2/1] [nSS] */
	...
	/* The group data rate of 1SS VHT BW40 */
	4,		0x47,		0,		25, 50,				3,		0, 0, 5,		1, 
	5,		0x47,		1,		25, 50,				4,		0, 0, 6,		1, 
	6,		0x47,		2,		15, 35,				5,		0, 0, 7,		1, 
	
//	4,		0x49,		0,		30, 50,				3,		0, 0, 5,		1, /* VHT, MCS0, BW80, STBC */
	7,		0x4B,		1,		20, 35,				6,		0, 0, 8,		1, /* VHT, MCS1, BW80, STBC */
	8,		0x4B,		2,		20, 35,				7,		0, 0, 9, 		1, /* VHT, MCS2, BW80, STBC */
	9,		0x4B,		3,		15, 30,				8,		0, 0, 10, 		1, /* VHT, MCS3, BW80, STBC */
	10,		0x4B,		4,		15, 30,				9,		0, 0, 11, 		1, /* VHT, MCS4, BW80, STBC */
	11,		0x4B,		5,		10, 25,				10,		0, 0, 12, 		1, /* VHT, MCS5, BW80, STBC */
	12,		0x4B,		6,		8, 15,				11,		0, 0, 13, 		1, /* VHT, MCS6, BW80, STBC */
	13,		0x4B,		7,		8, 15,				12,		0, 0, 14, 		1, /* VHT, MCS7, BW80, STBC */
	14,		0x4B,		7,		8, 15,				13,		0, 0, 15, 		1, /* VHT, MCS7, BW80, STBC, SGI */
	15,		0x4B,		8,		8, 15,				14,		0, 0, 16, 		1, /* VHT, MCS8, BW80, STBC */
	16,		0x4B,		9,		8, 15,				15,		0, 0, 17, 		1, /* VHT, MCS9, BW80, STBC */
	17,		0x4A,		9,		8, 15,				16,		0, 0, 17, 		1, /* VHT, MCS9, BW80, SGI */
};
	...
	IN ULONG			TxTotalCnt)
{
	...
	)
	{
		...
		BOOLEAN csd= FALSE;
#endif
#if defined(INCLUDE_DEBUG_QUEUE) || defined(DBG)
		ULONG tp;
#endif
#ifdef DBG
