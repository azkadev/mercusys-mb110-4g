...
#define APID_USED_FOR_ROAMING (0)
/**
...
typedef struct bs_current_sta_num_status {
	u_int8_t max_sta_num;
	u_int8_t current_sta_num;
}bs_current_sta_num_status;
/**
...
typedef struct ieee80211_bcnrpt_s {
    ...
    u_int8_t chnum;
    u_int8_t more;
}ieee80211_bcnrpt_t, *pieee80211_bcnrpt_t; 
...
typedef struct ath_netlink_bsteering_event {
    ...
    union {
		...
		struct bs_current_sta_num_status num_status;
...
typedef enum {
    ...
    ATH_EVENT_BSTEERING_STA_NUM_REPORT = 36,
} ATH_BSTEERING_EVENT;
