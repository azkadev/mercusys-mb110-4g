...
do{                                   \
    ...
    {                               \
		...
		printk("MT7610-->%s-%d)", __FUNCTION__, __LINE__); \
        printk Fmt;               \
    }                               \
}while(0)
...
/*IGMP */
#define RTMP_SET_PACKET_IGMP(_p, _flg)   													\
				do{ 																			\
					if (_flg)																	\
						(RTPKT_TO_OSPKT(_p)->cb[CB_OFF+11]) |= (RTMP_PACKET_SPECIFIC_IGMP); 	\
					else																		\
						(RTPKT_TO_OSPKT(_p)->cb[CB_OFF+11]) &= (~RTMP_PACKET_SPECIFIC_IGMP);	\
				}while(0)
#define RTMP_GET_PACKET_IGMP(_p)		(RTPKT_TO_OSPKT(_p)->cb[CB_OFF+11] & RTMP_PACKET_SPECIFIC_IGMP)
...
#define RTMP_PACKET_SPECIFIC_TX_ARP		0x01
#define RTMP_PACKET_SPECIFIC_RX_ARP		0x02
#define RTMP_PACKET_SPECIFIC_TX_ARP_BCAST		0x04
#define RTMP_PACKET_SPECIFIC_RX_ARP_BCAST		0x08
#define RTMP_PACKET_SPECIFIC_TX_ARP_RES		0x10
#define RTMP_PACKET_SPECIFIC_TX_ARP_REQ		0x20
#define RTMP_PACKET_SPECIFIC_RX_ARP_RES		0x40
#define RTMP_PACKET_SPECIFIC_RX_ARP_REQ		0x80

#define PACKET_CB(_p, _offset)	((RTPKT_TO_OSPKT(_p)->cb[CB_OFF + (_offset)]))

/* Specific */
#define RTMP_SET_PACKET_SPECIFIC_EXT(_p, _flg)	   	(PACKET_CB(_p, 36) = _flg)

/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_TX_ARP(_p, _flg)   								\
			do{															\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_TX_ARP);	\
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_TX_ARP);	\
			}while(0)
#define RTMP_GET_PACKET_SPECIFIC_TX_ARP(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_TX_ARP)

/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_RX_ARP(_p, _flg)   								\
			do{ 														\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_RX_ARP);	\
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_RX_ARP); \
			}while(0)
#define RTMP_GET_PACKET_SPECIFIC_RX_ARP(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_RX_ARP)

/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_TX_ARP_BCAST(_p, _flg)   								\
			do{ 														\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_TX_ARP_BCAST); \
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_TX_ARP_BCAST); \
			}while(0)

#define RTMP_GET_PACKET_SPECIFIC_TX_ARP_BCAST(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_TX_ARP_BCAST)

/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_RX_ARP_BCAST(_p, _flg)   								\
			do{ 														\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_RX_ARP_BCAST); \
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_RX_ARP_BCAST);	\
			}while(0)
#define RTMP_GET_PACKET_SPECIFIC_RX_ARP_BCAST(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_RX_ARP_BCAST)

/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_TX_ARP_RES(_p, _flg)   								\
			do{ 														\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_TX_ARP_RES); \
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_TX_ARP_RES); \
			}while(0)
#define RTMP_GET_PACKET_SPECIFIC_TX_ARP_RES(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_TX_ARP_RES)
/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_TX_ARP_REQ(_p, _flg)   								\
			do{ 														\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_TX_ARP_REQ); \
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_TX_ARP_REQ); \
			}while(0)
#define RTMP_GET_PACKET_SPECIFIC_TX_ARP_REQ(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_TX_ARP_REQ)
/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_RX_ARP_RES(_p, _flg)   								\
			do{ 														\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_RX_ARP_RES); \
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_RX_ARP_RES); \
			}while(0)
#define RTMP_GET_PACKET_SPECIFIC_RX_ARP_RES(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_RX_ARP_RES)

/* BCAST ARP */
#define RTMP_SET_PACKET_SPECIFIC_RX_ARP_REQ(_p, _flg)   								\
			do{ 														\
				if (_flg)												\
					PACKET_CB(_p, 36) |= (RTMP_PACKET_SPECIFIC_RX_ARP_REQ); \
				else													\
					PACKET_CB(_p, 36) &= (~RTMP_PACKET_SPECIFIC_RX_ARP_REQ); \
			}while(0)
#define RTMP_GET_PACKET_SPECIFIC_RX_ARP_REQ(_p)\
			(PACKET_CB(_p, 36) & RTMP_PACKET_SPECIFIC_RX_ARP_REQ)
