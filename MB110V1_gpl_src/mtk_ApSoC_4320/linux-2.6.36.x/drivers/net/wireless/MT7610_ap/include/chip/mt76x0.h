...
typedef struct _MT76x0_RATE_PWR_TABLE {
	...
	MT76x0_RATE_PWR_ITEM HT[8];/* it's the same with VHT form MCS0 to MCS7 */
	INT32 VHT20in4080Adj[9]; // only for storing HT20 sku_pwr in BBPcurrentBW==40/20 case
	INT32 VHT40in80Adj[10]; // only for storing HT40 sku_pwr in BBPcurrentBW==80/20 case
	INT32 HT20in40Adj[8]; // only for storing HT40 sku_pwr in BBPcurrentBW==80/20 case
	INT32 HT40in80Adj[8]; // only for storing HT40 sku_pwr in BBPcurrentBW==80 case
