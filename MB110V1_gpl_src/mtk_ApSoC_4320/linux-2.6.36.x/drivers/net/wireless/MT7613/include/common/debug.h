...
//patch from mtk to debug tx falut problem for S12 based on Linux kernel 2.6.x
//#define TX_FAULT_DEBUG
...
#if defined(TP_LOG_OFF)||defined(TP_LOG_ERROR)||defined(TP_LOG_WARN)||defined(TP_LOG_TRACE)||defined(TP_LOG_INFO)||defined(TP_LOG_LOUD)||defined(TP_LOG_NOISY)
#define TP_LOG 1
#endif
...
#else
void  printLevel(int Category,int SubCategory, int Level, const char *fmt, ...);

#define __REMOVE_BRACKET(fmt, ...) fmt, ##__VA_ARGS__
#define __DBGPRINT_RAW_NO_BRACKET(Category,SubCategory, Level, fmt, ...)		printLevel(Category,SubCategory, Level, fmt, ##__VA_ARGS__)
#define __DBGPRINT_RAW(Category,SubCategory,Level, Fmt)  __DBGPRINT_RAW_NO_BRACKET(Category,SubCategory, Level, __REMOVE_BRACKET Fmt)
#define MTWF_LOG(Category, SubCategory, Level, Fmt)      _DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#define _DBGPRINT_RAW(Category,SubCategory,Level, Fmt)   _DBGPRINT_RAW_##Level(Category,SubCategory, Level, Fmt)


//for some special code which uses variable level
#define _DBGPRINT_RAW_dbglvl(Category, SubCategory, Level, Fmt)        __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#define _DBGPRINT_RAW_dbg_lvl_error(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#define _DBGPRINT_RAW_dbg_lvl(Category, SubCategory, Level, Fmt)       __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#define _DBGPRINT_RAW_LogDbgLvl(Category, SubCategory, Level, Fmt)     __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#define _DBGPRINT_RAW_u1DebugLevel(Category, SubCategory, Level, Fmt)  __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)


#if defined(TP_LOG_OFF)||defined(TP_LOG_ERROR)||defined(TP_LOG_WARN)||defined(TP_LOG_TRACE)||defined(TP_LOG_INFO)||defined(TP_LOG_LOUD)||defined(TP_LOG_NOISY)
#define _DBGPRINT_RAW_0(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#else
#define _DBGPRINT_RAW_0(Category, SubCategory, Level, Fmt)
#endif

#if defined(TP_LOG_ERROR)||defined(TP_LOG_WARN)||defined(TP_LOG_TRACE)||defined(TP_LOG_INFO)||defined(TP_LOG_LOUD)||defined(TP_LOG_NOISY)
#define _DBGPRINT_RAW_1(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#else
#define _DBGPRINT_RAW_1(Category, SubCategory, Level, Fmt)
#endif

#if defined(TP_LOG_WARN)||defined(TP_LOG_TRACE)||defined(TP_LOG_INFO)||defined(TP_LOG_LOUD)||defined(TP_LOG_NOISY)
#define _DBGPRINT_RAW_2(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#else
#define _DBGPRINT_RAW_2(Category, SubCategory, Level, Fmt)
#endif

#if defined(TP_LOG_TRACE)||defined(TP_LOG_INFO)||defined(TP_LOG_LOUD)||defined(TP_LOG_NOISY)
#define _DBGPRINT_RAW_3(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#else
#define _DBGPRINT_RAW_3(Category, SubCategory, Level, Fmt)
#endif

#if defined(TP_LOG_INFO)||defined(TP_LOG_LOUD)||defined(TP_LOG_NOISY)
#define _DBGPRINT_RAW_4(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#else
#define _DBGPRINT_RAW_4(Category, SubCategory, Level, Fmt)
#endif

#if defined(TP_LOG_LOUD)||defined(TP_LOG_NOISY)
#define _DBGPRINT_RAW_5(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#else
#define _DBGPRINT_RAW_5(Category, SubCategory, Level, Fmt)
#endif

#if defined(TP_LOG_NOISY)
#define _DBGPRINT_RAW_6(Category, SubCategory, Level, Fmt) __DBGPRINT_RAW(Category, SubCategory, Level, Fmt)
#else
#define _DBGPRINT_RAW_6(Category, SubCategory, Level, Fmt)
#endif
