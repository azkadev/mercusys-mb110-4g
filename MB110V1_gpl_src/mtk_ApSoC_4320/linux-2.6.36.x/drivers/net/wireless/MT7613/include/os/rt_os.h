...
#ifdef APSD_SUPPORT
#define RTPRIV_IOCTL_CHAN_UTILIZATION               (SIOCIWFIRSTPRIV + 0x15)
#define RTPRIV_IOCTL_APC_DISCONNECT                 (SIOCIWFIRSTPRIV + 0x18)
#endif 

#ifdef AWND_SUPPORT
#define RTPRIV_IOCTL_GSITESURVEY_DECO				(SIOCIWFIRSTPRIV + 0x14)
#define RTPRIV_IOCTL_GET_CONFIG_GENERIC 			(SIOCIWFIRSTPRIV + 0x1D)
#endif
...
#define RTPRIV_IOCTL_GET_STA_INFO        			(SIOCIWFIRSTPRIV + 0x0B)
/* Added by wangbing. 2013-11-08 */
#define RTPRIV_IOCTL_GBSSINFO	(SIOCIWFIRSTPRIV + 0x1c)
#define RTPRIV_IOCTL_GRATEINFO	(SIOCIWFIRSTPRIV + 0x04)
#define RTPRIV_IOCTL_GSTAINFO	(SIOCIWFIRSTPRIV + 0x1e)
#define RTPRIV_IOCTL_GSCANINFO	(SIOCIWFIRSTPRIV + 0x06)
/* End Added. */
