...
BOOLEAN AsicMcastEntryInsert(struct _RTMP_ADAPTER *pAd, PMULTICAST_GROUP_ID pGrpId, UINT8 BssIdx, UINT8 Type, PUCHAR MemberAddr, PNET_DEV dev, UINT8 WlanIndex);
BOOLEAN AsicMcastEntryDelete(struct _RTMP_ADAPTER *pAd, PMULTICAST_GROUP_ID pGrpId, UINT8 BssIdx, PUCHAR MemberAddr, PNET_DEV dev, UINT8 WlanIndex);
#endif
...
#ifdef IGMP_SNOOP_SUPPORT
	BOOLEAN (*archMcastEntryInsert)(RTMP_ADAPTER *pAd, PMULTICAST_GROUP_ID pGrpId, UINT8 BssIdx, UINT8 Type, PUCHAR MemberAddr, PNET_DEV dev, UINT8 WlanIndex);
	BOOLEAN (*archMcastEntryDelete)(RTMP_ADAPTER *pAd, PMULTICAST_GROUP_ID pGrpId, UINT8 BssIdx, PUCHAR MemberAddr, PNET_DEV dev, UINT8 WlanIndex);
#endif
	INT (*asic_rts_on_off)(
