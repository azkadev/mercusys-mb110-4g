...
#define RTMP_SET_PACKET_PING_REQ(_p, _flg)		(PACKET_CB(_p, 100) = _flg)
#define RTMP_GET_PACKET_PING_REQ(_p)			(PACKET_CB(_p, 100))

#define RTMP_SET_PACKET_PING_RSP(_p, _flg)		(PACKET_CB(_p, 101) = _flg)
#define RTMP_GET_PACKET_PING_RSP(_p)			(PACKET_CB(_p, 101))

#define RTMP_SET_PACKET_DHCP_DISCOVER(_p, _flg)		(PACKET_CB(_p, 102) = _flg)
#define RTMP_GET_PACKET_DHCP_DISCOVER(_p)			(PACKET_CB(_p, 102))

#define RTMP_SET_PACKET_DHCP_OFFER(_p, _flg)		(PACKET_CB(_p, 103) = _flg)
#define RTMP_GET_PACKET_DHCP_OFFER(_p)			(PACKET_CB(_p, 103))

#define RTMP_SET_PACKET_DHCP_REQ(_p, _flg)		(PACKET_CB(_p, 104) = _flg)
#define RTMP_GET_PACKET_DHCP_REQ(_p)			(PACKET_CB(_p, 104))

#define RTMP_SET_PACKET_DHCP_ACK(_p, _flg)		(PACKET_CB(_p, 105) = _flg)
#define RTMP_GET_PACKET_DHCP_ACK(_p)			(PACKET_CB(_p, 105))
