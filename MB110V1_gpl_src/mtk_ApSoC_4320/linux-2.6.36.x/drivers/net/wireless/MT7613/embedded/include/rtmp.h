...
typedef struct _MULTICAST_GROUP_ID MULTICAST_GROUP_ID;
typedef struct _MULTICAST_GROUP_ID *PMULTICAST_GROUP_ID;
#endif
#endif
...
#ifdef APSD_SUPPORT
#define THESHOLD_FOR_ENTRY_DEL 5
#endif
...
#ifdef AWND_SUPPORT
	BOOLEAN AwndEnableAutoConnect; /* Set it as 1 if awnd allow aplci to auto connect */
#endif
	/* recv beacon part..... */
...
typedef struct _MAC_TABLE_ENTRY {
	...
	*/
	...
	ULONG OneSecRxBytes;
	/* added for apsd by JiangZheyu 2019/3/5 */ 
	ULONG actualRate;		/* actual data rate, Mbps */
	ULONG OneSecTxBytesTotal;
	ULONG OneSecRxBytesTotal;
