...
#define EEPROM_DEFAULT_FILE_PATH                     "/etc/MT7613_EEPROM.bin"
...
#define EEPROM_SIZE_ALL             0x10000                         //radio1 and radio2 config size
#define DEFAULT_WHOLE_RF_OFFSET     CONFIG_RT_FIRST_IF_RF_OFFSET    //from kernel menuconfig
#define MAX_RF_DATA_SIZE            0x8000                          //radio2 config size
