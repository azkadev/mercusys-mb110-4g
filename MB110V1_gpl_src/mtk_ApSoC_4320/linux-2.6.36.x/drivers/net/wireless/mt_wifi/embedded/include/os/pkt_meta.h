...
#define RTMP_GET_PACKET_WAI(_p) \
	...
	/* dhcp debug */
#define RTMP_SET_PACKET_DHCP_DEBUG(_p, _flg)   								\
				do{ 														\
					if (_flg)												\
						PACKET_CB(_p, 6) |= (RTMP_PACKET_SPECIFIC_WAI); \
					else													\
...
#define RTMP_GET_PACKET_DHCP_DEBUG(_p) \
				(PACKET_CB(_p, 6) & RTMP_PACKET_SPECIFIC_WAI)
...
/* [CB_OFF + 36]  */
/*
	Sepcific Pakcet Type definition extend
*/
#define RTMP_PACKET_SPECIFIC_CB_OFFSET_EXT	36
