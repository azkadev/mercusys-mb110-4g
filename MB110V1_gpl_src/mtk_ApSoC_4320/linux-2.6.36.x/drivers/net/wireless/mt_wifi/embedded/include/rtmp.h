...
#define THERMAL_PROTECT_DUTY_CYCLE_LEVEL_0          4
#define THERMAL_PROTECT_DUTY_CYCLE_LEVEL_1          3
#define THERMAL_PROTECT_DUTY_CYCLE_LEVEL_2          2
#define THERMAL_PROTECT_DUTY_CYCLE_LEVEL_3          1

#define THERMAL_PROTECT_ADMIT_PERIOD                127
#define THERMAL_PROTECT_ADMIT_TIME_100_PERCENT      254
#define THERMAL_PROTECT_ADMIT_TIME_60_PERCENT       152         // 254 * 0.6
#define THERMAL_PROTECT_ADMIT_TIME_30_PERCENT       76          // 254 * 0.3
#define THERMAL_PROTECT_ADMIT_TIME_10_PERCENT       25          // 254 * 0.1
#define TIME_UNIT_64US 1
#define TIME_UNIT_SEC 0
typedef struct _DUTY_ADMIT_DATA {
	UINT8 highen;
	UINT8 hightempth;
	UINT8 lowen;
	UINT8 lowtempth;
	UINT16 admchecktmr;
	UINT16 admdutylevel0;
	UINT16 admdutylevel1;
	UINT16 admdutylevel2;
	UINT16 admdutylevel3;
	UCHAR currentduty;
	UCHAR admiten;
}ADMIT_DATA,*PADMIT_DATA;
#endif
...
#define TX_SWQ_FIFO_LEN	512 //512
#else
#define TX_SWQ_FIFO_LEN	1024
#endif
...
typedef struct _SMART_CARRIER_SENSE_CTRL{
	...
	UINT8		EDCCA_Status;
	CHAR		SCSMode;    /* how to get the proper rssi from STA   0--smaller  1--bigger */
	CHAR		SCSL2H;     /* threshhold of changing L level to H level */
	CHAR		SCSH2L;     /* threshhold of changing H level to L level */
	CHAR		SCSTxrx;    /* whether to take txrx into account */
}SMART_CARRIER_SENSE_CTRL;
typedef CHAR (*RTMPGetScSRssi)(RTMP_ADAPTER *pAd, CHAR Rssi0, CHAR Rssi1, CHAR Rssi2);
...
/*=======Common=========== */
	...
	*/
	...
	UCHAR ApcliCustomAddress[MAC_ADDR_LEN];	/* User changed apcli if MAC address, TP add */
    BOOLEAN bCustomApcliMAC;	/* Use user changed MAC, TP add  */
...
#ifdef TP_IE_SUPPORT
	/* onemesh enable, TRUE is turn on, FALSE is turn off */
	BOOLEAN mesh_enable;
    BOOLEAN is_conn_specific_bssid; /*If enabled, RE will just connect the rootAp with the specific bssid */
    UINT16 node_id;  /* record rootap tpinfo node id */
#endif /* TP_IE_SUPPORT */
#ifdef DUTY_ADMIT_SUPPORT
	ADMIT_DATA admitctrl;
#endif
	USHORT AmsduAttack_Sequence; /*save sequence for amsdu attack*/ /*frag patch*/
};
