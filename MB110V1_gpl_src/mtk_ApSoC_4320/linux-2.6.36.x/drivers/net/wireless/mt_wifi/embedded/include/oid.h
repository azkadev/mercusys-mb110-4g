...
#ifdef TP_IE_SUPPORT
#define OID_GET_TPIE_INFO (0x0795)
#define RT_OID_GET_TPIE_INFO						(OID_GET_SET_TOGGLE | OID_GET_TPIE_INFO)
#define OLD_TPIE_DATA_LEN (26)
#define NEW_TPIE_DATA_LEN (30)
#endif /* TP_IE_SUPPORT */

#define RT_OID_WSC_QUERY_MODE 						0x0799 //0x764 has been used in 5g driver
...
typedef struct _AWND_NET_INFO {
    UCHAR            id;                       /* IEEE80211_ELEMID_VENDOR */
    UCHAR            len;                      /* length in bytes */
    UCHAR            oui[3];                   /* 0x00, 0x1d, 0x0f */
    UCHAR            tpie[TP_IE_MAX_LEN];      /* OUI type */ 
} AWND_NET_INFO;
#endif
...
typedef struct _REPTCLI_MAP_ENTRY
{
    UCHAR OriAddr[MAC_ADDR_LEN];
    UCHAR ReptCliAddr[MAC_ADDR_LEN];
    UCHAR IsEnabled;
    UCHAR IsValid;
    UCHAR IsEthCli;
