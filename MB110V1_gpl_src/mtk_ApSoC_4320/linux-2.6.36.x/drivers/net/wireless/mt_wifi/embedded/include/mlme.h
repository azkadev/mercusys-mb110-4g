...
#define MAX_LEN_OF_MLME_QUEUE            128 /*20*/ /*10 */
#endif
...
#define CHECK_TPIE_SUPPORT_MESH(bitmap) ((bitmap) &  ((0x01)<<(0)))
#define CHECK_TPIE_MESH_ENABLE(bitmap) ((bitmap) & ((0x01)<<(1)))
#endif /* TP_IE_SUPPORT */
...
#define MAC_ENTRY_LIFE_CHECK_CNT		128			/* packet cnt. *//* ori 1024 -> 128 */
