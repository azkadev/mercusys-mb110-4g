...
#define	RT_OID_WSC_QUERY_LOCK						0X075D
...
#define OID_802_11R_GET_STATION_LIST_INFO			0x0786
#define OID_802_11R_GET_STATION_INFO				0x0787
#define OID_802_11R_GET_PHYCAP_INFO					0x0788
#define OID_802_11R_GET_RSSI_INFO					0x0789
#define OID_802_11R_SEND_RRM_REQ					0x0790
#define OID_802_11R_SEND_BTM_REQ					0x0791
#define OID_802_11R_SCAN_EXAP_INFO					0x0792
#define OID_802_11R_GET_EXAP_INFO				0x0793
#define OID_802_11R_CLR_ASSOC_INFO				0x0794

#define RT_OID_802_11R_GET_STATION_LIST_INFO		(OID_GET_SET_TOGGLE | OID_802_11R_GET_STATION_LIST_INFO)
#define RT_OID_802_11R_GET_STATION_INFO				(OID_GET_SET_TOGGLE | OID_802_11R_GET_STATION_INFO)
#define RT_OID_802_11R_GET_PHYCAP_INFO				(OID_GET_SET_TOGGLE | OID_802_11R_GET_PHYCAP_INFO)
#define RT_OID_802_11R_GET_RSSI_INFO				(OID_GET_SET_TOGGLE | OID_802_11R_GET_RSSI_INFO)
#define RT_OID_802_11R_SEND_RRM_REQ					(OID_GET_SET_TOGGLE | OID_802_11R_SEND_RRM_REQ)
#define RT_OID_802_11R_SEND_BTM_REQ					(OID_GET_SET_TOGGLE | OID_802_11R_SEND_BTM_REQ)
#define RT_OID_802_11R_SCAN_EXAP_INFO				(OID_GET_SET_TOGGLE | OID_802_11R_SCAN_EXAP_INFO)
#define RT_OID_802_11R_GET_EXAP_INFO					(OID_GET_SET_TOGGLE | OID_802_11R_GET_EXAP_INFO)
#define RT_OID_802_11R_CLR_ASSOC_INFO				(OID_GET_SET_TOGGLE | OID_802_11R_CLR_ASSOC_INFO)
#endif

#define RT_OID_WSC_QUERY_MODE 						0x0799
...
#ifdef AIR_MONITOR
struct GNU_PACKED _mntr_entry_info {
	u8 mac[MAC_ADDR_LEN];
	u8 channel;
	u8 index;
};
...
struct GNU_PACKED _froam_command_hdr {
	UINT8 command_id;
	UINT8 command_len;
};

struct GNU_PACKED _threshold_info {
...
struct GNU_PACKED _cmd_froam_en {
	struct _froam_command_hdr hdr;
	UINT8 froam_en;
	UINT8 channel;
};

struct GNU_PACKED _cmd_threshold {
	struct _froam_command_hdr hdr;
...
struct GNU_PACKED froam_event_s {
	UINT8 event_id;
	UINT8 event_len;
	UINT8 event_body[0];
};

struct GNU_PACKED _froam_event_hdr {
	UINT8 event_id;
	UINT8 event_len;
};
...
struct GNU_PACKED _froam_event_sta_low_rssi {
	struct _froam_event_hdr hdr;
	UINT8 mac[MAC_ADDR_LEN];
	UINT8 channel;
};

struct GNU_PACKED _froam_event_sta_good_rssi {
	struct _froam_event_hdr hdr;
	UINT8 mac[MAC_ADDR_LEN];
};

struct GNU_PACKED _froam_event_sta_disconn {
	struct _froam_event_hdr hdr;
	UINT8 mac[MAC_ADDR_LEN];
};

struct GNU_PACKED _froam_event_param_cfg {
	struct _froam_event_hdr hdr;
	UINT8 value;
};
#endif
...
struct ieee80211req_sta_info {
        ...
        UINT8           isi_ps;         /* psmode */
        UINT8           isi_macaddr[MAC_ADDR_LEN];
        UINT8           isi_nrates;
                                                /* negotiated rates */
...
typedef struct _MAC_STAT_ENTRY
{
    ULONG  OneSecTxBytes;
    ULONG  OneSecRxBytes;
    ULONG  AssocRate;
