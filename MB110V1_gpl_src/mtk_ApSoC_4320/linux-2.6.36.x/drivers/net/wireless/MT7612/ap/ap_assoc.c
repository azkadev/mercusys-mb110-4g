...
/*extern void (*sfe_destroy_all_rules_for_dev) (struct net_device *dev);*/
#endif
...
#if 0
			if (sfe_destroy_all_rules_for_dev != NULL)
			{
				DBGPRINT(RT_DEBUG_OFF, ("ap_cmm_peer_assoc_req_action: Notify to Clear SFE rules \n"));
				sfe_destroy_all_rules_for_dev(NULL);
			}
#endif
			DBGPRINT(RT_DEBUG_OFF, ("%s %d send ATH_EVENT_BSTEERING_NODE_ASSOCIATED\r\n", __FUNCTION__, __LINE__));
