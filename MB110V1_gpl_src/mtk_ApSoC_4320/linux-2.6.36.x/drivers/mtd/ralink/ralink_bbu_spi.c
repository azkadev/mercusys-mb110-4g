...
#elif defined (CONFIG_TP_MODEL_MR100V2) || defined (CONFIG_TP_MODEL_MB110V1) //MR100V2
...
long flash_ioctl (struct file *filp, unsigned int cmd, unsigned long arg)
{
    ...
    case FLASH_IOCTL_WRITE:
	{
		...
		if (need_reboot)
		{
			//rsl���sleep�Ƶ�kernel����������ȷ��sleep 30����ʲô�ã��Է���һ������ƣ����Ǹ��������¼��sleep��˳����������ӿ�һ����¼�����������ڼ�ϵ�ķ���
			printk("sleep 30 before reboot\n");
			usleep(1000*1000*30);
